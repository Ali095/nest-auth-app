...
export class UsersService {
  ...
  async getUsers(filterDto: UserDataDto): Promise<User[]> {
    return this.dbRepo.getUsers(filterDto);
  }

  async getUserById(id: string): Promise<User> {
    return this.dbRepo.getUserById(id);
  }
  ...
  async updateUser(id: string, userDataDto: UserDataDto): Promise<User> {
    return this.dbRepo.updateUser(id, userDataDto);
  }

  async deleteUserById(id: string): Promise<void> {
    return this.dbRepo.deleteUserById(id);
  }
}
